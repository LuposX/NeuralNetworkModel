...
if __name__ == "__main__":
    ...
    # Neural Network
    net = CNN.load_from_checkpoint("mnist-classifier_linear_0/version_8b0fda00886c405cb49679a86c0c41c4_0/checkpoints/epoch=4.ckpt")

    image = Image.open("self_drawn_images/3_0.png")

    preproc = transforms.Compose([
        transforms.ToTensor()
    ])

    img_tensor = preproc(image)
